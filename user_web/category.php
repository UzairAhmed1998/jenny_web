			...
			<div class="col-xl-9 col-lg-8 col-md-7"> -->
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						<?php
						   $id = $_GET['cat_id'];
							$fetch_book="SELECT * FROM books WHERE cate_id ='{$id}'";
						...
						<div class="col-lg-4 col-md-6">
							...
							<a href="product_details.php?book_id=<?php echo $data['b_id'] ?>" class="social-info">
								<img class="img-fluid" src="../admin/media/<?php echo $data['b_image'] ?>" alt="" style="height:300px;" >
								</a>
