...
if(isset($_POST['add'])){
    ...
    $status=$_POST['status'];
        ...
        $insert_reg = "INSERT INTO orders_status(id,status)VALUES('{$id}','{$status}')";
        $res_reg = mysqli_query($con,$insert_reg);
        if($res_reg){
            echo "<script>alert('you have successfully add Order Status')</script>";
...
<head>
  ...
  <title>Jenny's Choice - Add Order Status</title>
      ...
      <?php require_once 'topbar.php' ?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Order Status</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-10">
              ...
              <div class="card mb-4">
                ...
                <form method="POST">
                    ...
                    <br>
                    <div class="form-group">
                      <button type="submit" name="add" class="btn btn-primary btn-block">Add Order Status</button>
                    </div>
                    <hr>
