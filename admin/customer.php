...
$slct_query = "SELECT * FROM customer";
...
<head>
  ...
  <title>Jenny's Choice - Customers Detail</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">Customers Detail</h1>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      <td>
                        ...
                        <a href="cus_delete.php?cu_id=<?php echo $data['cus_id'] ?>" role="button" class="btn btn-danger" >Delete</a>
                      </td>
