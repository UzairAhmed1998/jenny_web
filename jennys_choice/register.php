...
if(isset($_POST['register'])){
    ...
    $number=$_POST['number'];
    $pass=$_POST['pass'];
    $insert="INSERT INTO customer (cus_id,cus_name,cus_email,cell_no,dob,cus_password)VALUES('{$id}', '{$name}', '{$email}', '{$number}', '{$date}', '{$pass}')";
    $insert_reg=mysqli_query($con,$insert);
    if($insert_reg){
        echo "<script>alert('Your account is registered now..!')</script>";
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="checkout__form__input">
                                    <p>Email<span>*</span></p>
                                    <input type="text" required name="email" placeholder="example@gmail.com">
